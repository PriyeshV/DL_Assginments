...
def distorted_inputs(data_dir, batch_size):
  ...
  min_queue_examples = int(N_TRAIN *
...
def inputs(dataset, data_dir, batch_size):
  """Construct input for CIFAR evaluation using the Reader ops.

  Args:
    dataset: string, "train", "validation", "test" - otherwise
    data_dir: Path to the CIFAR-10 data directory.
    batch_size: Number of images per batch.
  ...
  if dataset == 'train':
    ...
    num_examples_per_epoch = N_TRAIN
      ...
      num_examples_per_epoch = N_TEST
  else:
    filenames = [os.path.join(data_dir, 'test_batch_1.bin')]
    num_examples_per_epoch = N_TEST
